...
with st.sidebar:
    st.markdown(f'<div style="font-size:22px;font-weight:800;color:{B}">🦅 GrekoTrader</div>'
            ...
            f'v13 · 26 Abr 2026 · Backtesting + Soporte/Resistencia · '
...
COLS_MAIN=["Ticker","Score_Rebote","Nivel_Rebote","Etapa_v12","Area","Precio","RSI","DD_pico","Prob_NBIS","Motivo","Lectura"]
